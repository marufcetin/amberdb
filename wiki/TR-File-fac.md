...
`.fac` dosyasi, kayit ID ofsetine gore ileri yonlu sutun nitelik degerlerini saklar. Cift yonlu metin sozlukleri (`_${blok}.unq` / `_${blok}.str`) ile birlikte calisarak ayrik (disjunctive) facet sayimlarinin aninda hesaplanmasini saglar.
