...
`facet_menu()`, e-ticaret ve katalog arayuzleri icin gercek zamanli, cok boyutlu dinamik filtre menuleri ve secenek sayimlari uretir. Kolon tabanli bitset dosyalarini (`.fac`) ve cift yonlu sozlukleri (`.unq` / `.str`) kullanarak ayrik (disjunctive) sayimlari aninda hesaplar.
