...
> Semada tanimlanan indeks alanlari (`match_block => [1, 2 ]`, `search_block => [1 ]`, `sort_block => 3`), `@kayit` dizisinin 1-tabanli veri bloklarini gosterir. 1. Blok `$kayit[1]`, 2. Blok `$kayit[2]` dir. 0. blok daima birincil anahtara ayrilmistir; arama veya filtre blogu olarak atanmamalidir.
