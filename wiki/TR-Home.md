...
| **G** | [get_cache](TR-Method-get_cache) · [Global Bayraklar](TR-Concept-Global-Flags) |
...
### 5. Surec Ici Onbellek ve Dusuk Seviyeli Metotlar
- [get_cache](TR-Method-get_cache) - L1 surec ici onbelleginden kayit okuma
- [set_cache](TR-Method-set_cache) - L1 surec ici onbellegine kayit yazma veya silme
...
- [dbase_dir](TR-Flag-dbase_dir) - Kok depolama dizini yolu
- [table_dir](TR-Flag-table_dir) - Ozel tablo alt dizini yonlendirmesi
