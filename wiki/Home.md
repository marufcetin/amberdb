...
| **G** | [get_cache](Method-get_cache) · [Global Flags](Concept-Global-Flags) |
...
### 5. Cache and Low-Level Access Methods
- [get_cache](Method-get_cache) - Reads entry or group from in-memory L1 cache
- [set_cache](Method-set_cache) - Sets, updates, or deletes entry in in-memory L1 cache
...
- [dbase_dir](Flag-dbase_dir) - Root storage directory path
- [table_dir](Flag-table_dir) - Custom table subdirectory routing
