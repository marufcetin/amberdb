...
| **`journal/`** | `dbstore/journal/txn_${epoch}_${seq}_${pid}` | Sıralı log akışı | `0x1E` (RS) ayraçlı Base64 delta kayıtları | ACID Strict 2PL işlem geri alma (undo-journal) günlüğü. |
